defmodule BlacklistBackend do
  ...
  @spec createEntry(String.t, String.t, String.t, String.t, String.t, String.t, String.t) :: token
  defdelegate createEntry(entity_name, list_type, list_name, start_date, end_date, user_id, reason), to: Backend

  @spec deleteEntry(token) :: boolean()
  defdelegate deleteEntry(entry_token), to: Backend

  @spec updateEntry(token) :: boolean()
  defdelegate updateEntry(entry_token), to: Backend
